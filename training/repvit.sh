#!/bin/bash
#SBATCH --job-name=repvit23-512
#SBATCH --output=/home/%u/logs/%A_%x
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-gpu=7 
#SBATCH --mem-per-gpu=50G
#SBATCH --exclude=stc01sppamxnl018
...
RUN_ID="repvit_M2.3_512"

DATA_DIR="/data2/jupiter/datasets"
DATASET="halo_rgb_stereo_train_v6_2"
# DATASET="/data2/jupiter/datasets/halo_rgb_stereo_train_v6_2_full_res"
...
HUMAN_AUG_CSV="${DATA_DIR}/${DATASET}/master_annotations_dedup_clean_ocal_20240208_50k_intersection_cutnpaste.csv"
