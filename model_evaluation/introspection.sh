...
CHECKPOINT_FULL_PATH=/mnt/sandbox1/alex.li/train_seg_halo/25017_highres/checkpoints/last.ckpt
...
do
    ...
    srun --kill-on-bad-exit python -m kore.scripts.predict_seg \
        ...
        --metrics.depth_thresholds.T_front .4 \
        --metrics.depth_thresholds.T_rear .45 \
        --metrics.depth_thresholds.T_side .4 \
        --metrics.depth_thresholds.I .4 \
