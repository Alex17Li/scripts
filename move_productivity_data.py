...
# Need to merge the clean datasets into alethia into one big dset at some point
...
# with open('/home/alex.li/git/scripts/ids_to_drop.json') as f:
#     ids_to_drop = json.load(f)
# df = pd.read_csv(target_dset + 'master_annotations.csv')
# df_less = df[~df['id'].isin(ids_to_drop)]
# df_less.to_csv(target_dset + 'master_annotations_v1.csv')
