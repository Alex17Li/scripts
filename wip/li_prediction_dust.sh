...
#SBATCH --output=/home/li.yu/code/scripts/v53_4cls_tversky001_imgaug_60p_0209_train.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# experiment name
EXP='v53_4cls_tversky001_imgaug_60p_0209'
...
# # SAFETY_DATASETS=("humans_on_path_test_set_2023_v9_anno")
# for DATASET in ${SAFETY_DATASETS[@]}
# do
# # run testing on critical safety 2023 v6, on master
